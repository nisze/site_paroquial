...
-- Tabela auxiliar para padroeiros
...
-- ==============================================
-- TABELA: INFORMACOES_PERMANENTES
-- ==============================================
...
COMMENT ON TABLE eventos IS 'Eventos especiais da paróquia';
...
COMMENT ON TABLE contatos_whatsapp IS 'Contatos para mensagens automáticas';
